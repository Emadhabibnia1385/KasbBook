...
| `KASBBOOK_DOCS_URL` | *(this project's site)* | The written guide the bot links to beside the API reference. It documents the software rather than your deployment, which is why it has a default at all; point it at your own if your copy has drifted, or set it to nothing to drop the button. |
